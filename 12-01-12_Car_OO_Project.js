...
// Each vehicle instance should have a method called toString, which returns the string containing the make, 
//  model and year.
...
class Garage {
    constructor(capacity) {
        ...
        if (!Number.isFinite(capacity)) {
            throw new Error(`Capacity '${capacity}' is ${typeof (capacity)} when a number was expected.`);
        }
...
let garageFillTests = new Garage(2);
